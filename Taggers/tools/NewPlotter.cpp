/*
g++ -Wall -o NewPlotter `root-config --cflags --glibs` -L $ROOTSYS/lib -lRooFitCore -lFoam -lMinuit -lMathMore CMS_lumi.C tdrstyle.C NewPlotter.cpp
*/
...
//		for(int i=0; i<100; i++)
	...
	if(isLept)
	{	system("mv *.png ~/www/ttH/Full2016Dataset/Leptonic");
		system("mv *.pdf ~/www/ttH/Full2016Dataset/Leptonic");
	}
	else
	{	system("mv *.png ~/www/ttH/Full2016Dataset/Hadronic");
		system("mv *.pdf ~/www/ttH/Full2016Dataset/Hadronic");
	}
	...
	if(isLept)
	{	system("mv *.png ~/www/ttH/Full2016Dataset/Leptonic/Jets");
		system("mv *.pdf ~/www/ttH/Full2016Dataset/Leptonic/Jets");
	}
	else
	{	system("mv *.png ~/www/ttH/Full2016Dataset/Hadronic/Jets");
		system("mv *.pdf ~/www/ttH/Full2016Dataset/Hadronic/Jets");
	}
