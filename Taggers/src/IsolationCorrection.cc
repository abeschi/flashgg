...
IsolationCorrection::IsolationCorrection(const char * fname)
{
...
float IsolationCorrection::getExtra(float eta, float rho, float extraMult)
{
...
int IsolationCorrection::findIndex(float val, std::vector<float> & vec)
{
...
std::vector<float> IsolationCorrection::convertToStd(TVectorD * input)
{
...
std::vector<int> IsolationCorrection::convertToStdInt(TVectorD * input)
{
