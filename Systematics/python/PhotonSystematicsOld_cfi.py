...
# central EB (eta<0.8) low full5x5_r9  0.035
# central EB (eta<0.8) high full5x5_r9  0.033
# intermediate EB (0.8 < eta < 1.0) low full5x5_r9  0.058
# intermediate EB (0.8 < eta < 1.0) high full5x5_r9  0.12
# outer EB (eta>1.0) low full5x5_r9  0.22
# outer EB (eta>1.0) high full5x5_r9  0.34
# EE low full5x5_r9  0.22
# EE high full5x5_r9  0.34
#
...
MaterialCentral = cms.PSet( MethodName = cms.string("FlashggPhotonScale"),
...
flashggPhotonSystematics = cms.EDProducer('FlashggPhotonSystematicProducer',
		src = cms.InputTag("flashggUpdatedIdMVAPhotons"),
